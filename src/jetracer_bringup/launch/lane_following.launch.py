...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('steering_smoothing', default_value='0.25'),
        DeclareLaunchArgument('controller_lookahead_m', default_value='0.35'),
        ...
        DeclareLaunchArgument('publish_ackermann_drive', default_value='true'),
        DeclareLaunchArgument('publish_legacy_twist', default_value='true'),

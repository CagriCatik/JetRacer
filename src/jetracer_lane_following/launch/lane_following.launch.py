...
def generate_launch_description() -> LaunchDescription:
    return LaunchDescription([
        ...
        DeclareLaunchArgument('gain_constant', default_value='1.8'),
        DeclareLaunchArgument('damping_constant', default_value='0.25'),
        ...
        DeclareLaunchArgument('controller_heading_points', default_value='4'),
        ...
        DeclareLaunchArgument('max_steering_rate_radps', default_value='3.0'),

        DeclareLaunchArgument('gradient_threshold', default_value='14.0'),
        DeclareLaunchArgument('spline_smoothness', default_value='10.0'),
        DeclareLaunchArgument('fallback_lane_width_px', default_value='220.0'),
        DeclareLaunchArgument('lane_width_ema_alpha', default_value='0.25'),
        DeclareLaunchArgument('lane_width_min_px', default_value='160.0'),
        DeclareLaunchArgument('lane_width_max_px', default_value='280.0'),
        DeclareLaunchArgument('bev_vehicle_center_x_px', default_value='160.0'),
        DeclareLaunchArgument('bev_vehicle_origin_y_px', default_value='239.0'),
        DeclareLaunchArgument('bev_lateral_m_per_px', default_value='0.0022'),
        DeclareLaunchArgument('bev_forward_m_per_px', default_value='0.0030'),
        DeclareLaunchArgument('speed_curvature_gain', default_value='2.5'),
        DeclareLaunchArgument('speed_confidence_floor', default_value='0.35'),
        DeclareLaunchArgument('path_frame_id', default_value='base_link'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'controller_heading_points': LaunchConfiguration('controller_heading_points'),
                ...
                'max_steering_rate_radps': LaunchConfiguration('max_steering_rate_radps'),
                'gradient_threshold': LaunchConfiguration('gradient_threshold'),
                'spline_smoothness': LaunchConfiguration('spline_smoothness'),
                'fallback_lane_width_px': LaunchConfiguration('fallback_lane_width_px'),
                'lane_width_ema_alpha': LaunchConfiguration('lane_width_ema_alpha'),
                'lane_width_min_px': LaunchConfiguration('lane_width_min_px'),
                'lane_width_max_px': LaunchConfiguration('lane_width_max_px'),
                'bev_vehicle_center_x_px': LaunchConfiguration('bev_vehicle_center_x_px'),
                'bev_vehicle_origin_y_px': LaunchConfiguration('bev_vehicle_origin_y_px'),
                'bev_lateral_m_per_px': LaunchConfiguration('bev_lateral_m_per_px'),
                'bev_forward_m_per_px': LaunchConfiguration('bev_forward_m_per_px'),
                'speed_curvature_gain': LaunchConfiguration('speed_curvature_gain'),
                'speed_confidence_floor': LaunchConfiguration('speed_confidence_floor'),
